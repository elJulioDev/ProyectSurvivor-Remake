...
## ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
##  SpawnManager v3.1 — Sistema de Oleadas estilo Vampire Survivors
##
##  CAMBIO PRINCIPAL respecto a v3:
##    · _get_spawn_position() ahora usa cam.get_screen_center_position()
##      en lugar de _player_pos como centro de referencia.
##
##      Problema anterior: cuando el jugador estaba en la esquina del
##      mapa, la cámara quedaba clampeada (p.ej. x=640). Los enemigos
##      se spawnaban fuera del jugador pero DENTRO de la vista de la
##      cámara, haciéndose visibles al aparecer.
##
##      Solución: usar la posición REAL del centro de la cámara
##      (post-clamp). Así los enemigos siempre aparecen fuera del
##      rectángulo visible, independientemente de si la cámara está
##      clampeada o no.
## ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
# ════════════════════════════════════════════════════════════════
#  POSICIÓN DE SPAWN — relativa a la cámara real
##
##  FIX CLAVE: usamos cam.get_screen_center_position() como centro.
##  Cuando la cámara está clampeada en una esquina, esa función
##  devuelve la posición real del viewport, NO la del jugador.
##  Los enemigos spawnan fuera del rectángulo visible correcto.
# ════════════════════════════════════════════════════════════════
...
func _get_spawn_position() -> Vector2:
	...
	if is_instance_valid(cam):
		...
		# ── Centro real de la cámara (post-clamp) ─────────────────
		# En esquinas del mapa: cam.get_screen_center_position() ≠ player.position
		# Usar este valor garantiza que los enemigos aparecen fuera
		# del área VISIBLE, no solo fuera del jugador.
		spawn_center = cam.get_screen_center_position()
	else:
		# Fallback sin cámara disponible
		var angle  := randf() * TAU
	...
	# ── Sesgo direccional según movimiento del jugador ────────────
	...
	if moving:
		...
		if roll < 0.50:
			...
			side = (_fwd_side(fwd) + 1) % 4
		else:
			side = (_fwd_side(fwd) + 3) % 4
	else:
		side = randi() % 4
	...
	match side:
		0: # arriba
			pos = Vector2(
				spawn_center.x + randf_range(-half_x, half_x),
				spawn_center.y - half_y
			)
		1: # derecha
			pos = Vector2(
				spawn_center.x + half_x,
				spawn_center.y + randf_range(-half_y, half_y)
			)
		2: # abajo
			pos = Vector2(
				spawn_center.x + randf_range(-half_x, half_x),
...
## Convierte dirección a índice de borde (0=top 1=right 2=bottom 3=left)
