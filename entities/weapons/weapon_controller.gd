...
var current_spreads: Dictionary = {}
var muzzle_timers: Dictionary = {}
...
func _fire_laser(weapon: WeaponData) -> void:
	...
	var dmg_this_frame = weapon.damage \
	...
	var hits = GameManager.enemy_manager.get_enemies_near_proxy(
		start_pos + (laser_end_point - start_pos) / 2.0, max_len)
